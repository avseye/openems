...
.Details on B-Control Energy Meter
|===
|Bridge |<<_modbus_tcp>>
1.3+|Implemented Natures | <<MeterNature>>
| <<SymmetricMeterNature>>
| <<AsymmetricMeterNature>>
|More information |https://www.b-control.com/en/products/em-300.html[Manufacturer icon:external-link[]]
|===

.Channels of B-Control Energy Meter
[options="header"]
|===
